...
class SectionCard extends StatelessWidget {
  const SectionCard({
    required this.child,
    this.padding = const EdgeInsets.all(AppCustomTokens.spaceMd),
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      children: [
        ...
        Text(
          '  ✦',
          style: textTheme.titleSmall?.copyWith(color: AppColors.cardBorder),
        ),
        const Spacer(),
        if (trailing != null)
          Text(
          ...
          Container(
            width: AppCustomTokens.bottomBarReservedHeight,
